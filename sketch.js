...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    trex.velocityX=0; //parar al dinosaurio
    trex.changeAnimation("collided",trex_collided); //colision

    obstaclesGroup.setLifetimeEach(-1); //parar la generacion de obstaculos
    cloudsGroup.setLifetimeEach(-10); //parar la generacion de las nubes
